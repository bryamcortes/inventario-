            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoPerfil">
                  ...
                  <option value="Administrador_comercial">Administrador comercial</option>
            ...
            <div class="row">
                  <div class="col-md-10">
                    ...
                    <div class="input-group">
                        ...
                        <input ID="txtPassword" type="password" class="form-control input-lg" name="editarPassword" placeholder="Escriba la nueva contraseña">
